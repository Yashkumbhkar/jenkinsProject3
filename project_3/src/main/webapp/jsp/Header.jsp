		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PATIENT_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Patient
						</a> <a class="dropdown-item" href="<%=ORSView.PATIENT_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Patient List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Lession</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.LESSION_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Lession
						</a> <a class="dropdown-item" href="<%=ORSView.LESSION_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Lession List</a>
					</div></li>
					...
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Product</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PRODUCT_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Product
						</a> <a class="dropdown-item" href="<%=ORSView.PRODUCT_LIST_CTL%>"><i
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.INVENTORY_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Inventory
						</a> <a class="dropdown-item" href="<%=ORSView.INVENTORY_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>  Inventory List</a>
					</div></li>
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PRODUCT_DETAILS_CTL%>"> <i
							class="fas fa-user-circle"></i>Add ProductDetails
						</a> <a class="dropdown-item" href="<%=ORSView.PRODUCT_DETAILS_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>ProductDetails List</a>
					</div></li>
